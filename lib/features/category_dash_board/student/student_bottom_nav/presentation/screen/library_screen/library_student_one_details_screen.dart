...
class LibraryStudentOneDetailsScreen extends StatefulWidget {
  const LibraryStudentOneDetailsScreen({super.key});

  @override
  State<LibraryStudentOneDetailsScreen> createState() => _LibraryStudentOneDetailsScreenState();
}

class _LibraryStudentOneDetailsScreenState extends State<LibraryStudentOneDetailsScreen> {
