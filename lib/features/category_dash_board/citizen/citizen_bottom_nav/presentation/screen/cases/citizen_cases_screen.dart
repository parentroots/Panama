          ...
          body: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                CommonText(text: 'Check the status of your legal cases.',fontWeight: FontWeight.w500,color: Color(0xff458AFF),),
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                return Column(
                                  children: [
                                    SizedBox(height: 20),
                                   NotAttendedCard(topic: 'Family lawy Alimony', status: 'No lawyer found available')
                                  ],
                                );
                              },
                            ),
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                return Column(
                                  children: [
                                    SizedBox(height: 20),
                                   RecordCard(date: '12/122025', title: 'Contact Review', status: AppointmentStatus.completed,)
                                  ],
                                );
                              },
                            ),
