...
class LibraryCitizenOneDetailsScreen extends StatefulWidget {
  const LibraryCitizenOneDetailsScreen({super.key});

  @override
  State<LibraryCitizenOneDetailsScreen> createState() => _LibraryCitizenOneDetailsScreenState();
}
