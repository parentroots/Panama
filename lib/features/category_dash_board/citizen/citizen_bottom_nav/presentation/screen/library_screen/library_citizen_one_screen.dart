...
import 'library_citizen_one_details_screen.dart';


class LibraryCitizenOneScreen extends StatefulWidget {
  const LibraryCitizenOneScreen({super.key});

  @override
  State<LibraryCitizenOneScreen> createState() => _LibraryCitizenOneScreenState();
}

class _LibraryCitizenOneScreenState extends State<LibraryCitizenOneScreen> {
  @override
          ...
          children: [
            ...
            _buildCardWidget(
              ...
              onTap: () {
                ...
                Get.to(LibraryCitizenOneDetailsScreen());
              },
            ),
