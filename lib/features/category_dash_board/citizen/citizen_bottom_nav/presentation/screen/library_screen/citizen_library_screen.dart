...
class CitizenLibraryScreen extends StatefulWidget {
  const CitizenLibraryScreen({super.key});

  @override
  State<CitizenLibraryScreen> createState() => _CitizenLibraryScreenState();
}

class _CitizenLibraryScreenState extends State<CitizenLibraryScreen> {
  @override
          ...
          children: [
            ...
            LawLibraryCard(
              ...
              subTitleText: 'See related articles', onTap: () {
                Get.to(LibraryCitizenOneScreen());
            },
            ),
