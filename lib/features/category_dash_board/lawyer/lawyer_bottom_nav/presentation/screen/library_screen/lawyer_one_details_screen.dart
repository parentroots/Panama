...
class LibraryLawyerOneDetailsScreen extends StatefulWidget {
  const LibraryLawyerOneDetailsScreen({super.key});

  @override
  State<LibraryLawyerOneDetailsScreen> createState() => _LibraryLawyerOneDetailsScreenState();
}

class _LibraryLawyerOneDetailsScreenState extends State<LibraryLawyerOneDetailsScreen> {
