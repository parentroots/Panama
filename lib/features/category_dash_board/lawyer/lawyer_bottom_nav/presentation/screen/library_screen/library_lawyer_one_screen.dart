...
import 'lawyer_one_details_screen.dart';


class LibraryLawyerOneScreen extends StatefulWidget {
  const LibraryLawyerOneScreen({super.key});

  @override
  State<LibraryLawyerOneScreen> createState() => _LibraryLawyerOneScreenState();
}

class _LibraryLawyerOneScreenState extends State<LibraryLawyerOneScreen> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: const LawyerBottomNavBar(currentIndex: 1),
          ...
          children: [
            ...
            _buildCardWidget(
              ...
              onTap: () {
                ...
                Get.to(LibraryLawyerOneDetailsScreen());
              },
            ),
