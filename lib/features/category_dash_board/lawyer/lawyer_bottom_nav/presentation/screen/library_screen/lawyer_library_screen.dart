...
import 'library_lawyer_one_screen.dart';

class LawyerLibraryScreen extends StatefulWidget {
  const LawyerLibraryScreen({super.key});

  @override
  State<LawyerLibraryScreen> createState() => _LawyerLibraryScreenState();
}

class _LawyerLibraryScreenState extends State<LawyerLibraryScreen> {
  @override
