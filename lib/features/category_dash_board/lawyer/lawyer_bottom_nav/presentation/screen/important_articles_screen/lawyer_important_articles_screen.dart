...
class LawyerImportantArticlesScreen extends StatefulWidget {
  ...
  @override
  State<LawyerImportantArticlesScreen> createState() =>
      _LawyerImportantArticlesScreenState();
}

class _LawyerImportantArticlesScreenState
    extends State<LawyerImportantArticlesScreen> {
            ...
            Expanded(
              child: PageView(
                ...
                children: [
                  ...
                  /// Criminal
                  buildListPage(List.generate(10, (_) => CriminalCard())),

                  /// Civil
                  buildListPage(List.generate(10, (_) =>  Column(
                    children: [
                      CriminalCard(),
  ...
  /// TAB WIDGET
  Widget buildTab(String text, int index, Color color, {double width = 80}) {
    return InkWell(
