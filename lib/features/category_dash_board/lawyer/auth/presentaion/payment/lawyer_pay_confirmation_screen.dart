...
class LawyerPayConfirmationScreen extends StatefulWidget {
  const LawyerPayConfirmationScreen({super.key});

  @override
  State<LawyerPayConfirmationScreen> createState() => _LawyerPayConfirmationScreenState();
}

class _LawyerPayConfirmationScreenState extends State<LawyerPayConfirmationScreen> {
  @override
