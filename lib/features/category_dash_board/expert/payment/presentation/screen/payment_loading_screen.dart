...
class ExpertPaymentLoadingScreen extends StatefulWidget {
  const ExpertPaymentLoadingScreen({super.key});

  @override
  State<ExpertPaymentLoadingScreen> createState() => _ExpertPaymentLoadingScreenState();
}

class _ExpertPaymentLoadingScreenState extends State<ExpertPaymentLoadingScreen> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    Future.delayed(Duration(seconds: 2), () {
      Get.to(ExpertPendingValidationScreen());
    });
  }
