...
///------------------------expert-------------------------
  ...
  static List<GetPage> routes = [
    ...
    GetPage(name: bill_plan_screen, page: () => const ExpertBilPlanScreen()),
    ...
    GetPage(name: paymentLoadingScreen, page: () => ExpertPaymentLoadingScreen()),
    GetPage(name: pendingValidationScreen, page: () => ExpertPendingValidationScreen()),
   ...
   // GetPage(name: expertBottomNavScreen, page: () => ExpertBottomNavScreen())
    ...
    // GetPage(name: expertSignUpScreen, page: () => const ExpertSignUpScreen()),
     GetPage(name: citizenInformationUploadScreen, page: () => const CitizenInformationUploadScreen()),
       GetPage(name: citizen_bill_plan_screen, page: () => const ExpertBilPlanScreen()),
    ...
    // GetPage(name: payment_method_screen, page: () => PaymentMethodScreen()),
      GetPage(name: studentLoadingScreen, page: () => StudentPaymentLoadingScreen()),
